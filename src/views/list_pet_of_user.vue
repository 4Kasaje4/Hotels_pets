<template>
    ...
    <div ref="show_menu">
      ...
      <div style="height: 100px; background: linear-gradient(180deg, #fdde91 0%, #f9f2d4 100%); padding: 0 2% 0 2%; display: flex; justify-content: space-between; align-items: center;">
        ...
        <div style="display: flex; justify-content: space-around; width: 30%; align-items: center; margin-right: -10px;">
          ...
          <div @click="go_caretaker(this.$router.push({name : 'adminpage', params : {role : this.$route.params.role, id : this.$route.params.id, login_id : this.$route.params.login_id}}))" style="cursor: pointer; border-radius: 50%; width: 60px; height: 60px; background-color:#fdde91; display: flex; align-items: center; ">
            ...
            <div style="display: flex; justify-content: center">
              ...
              >
                ...
                <div style="width: 100%; margin-left: -5%">
                  ...
                  <button @click="details_pet(this.$route.params.your_id,pet_data['pet_id'])" class="button2"><p class="textbut">รายละเอียด</p></button>
                </div>
              </div>
            </div>
          </div>
    ...
    export default {
      ...
      methods: {
        ...
        async loaddata() {
          const data = {
            user_id: this.$route.params.your_id,
          };
      ...
      transform: translate(-50%, -50%);">
        ...
        async details_pet(user_id, input_pet_id){
          this.$router.push({name: 'details_user_adminView', params: {role: this.$route.params.role, id: this.$route.params.id, login_id: this.$route.params.login_id,your_id : user_id , pet_id : input_pet_id}})
        },
        async go_profile(){
